# pi-ephemeral minimal skill package
...
- `skill ephemeral-example`

This example is intended to be copied or recreated into a local package directory such as `~/.pi/packages/pi-ephemeral-example-resources`.
